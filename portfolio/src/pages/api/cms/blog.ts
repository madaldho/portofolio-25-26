    ...
    const blogPosts = [
      // Simulated blog posts for now
      {
        ...
        fields: {
          ...
          excerpt: { 'en-US': 'This is my first blog post!' },
          content: { 'en-US': '<p>Welcome to my blog where I share my thoughts on technology and development.</p>' },
          tags: { 'en-US': ['welcome', 'introduction'] },
  ...
  try {
    ...
    const updatedEntry = {
      ...
      fields: {
        ...
        excerpt: { 'en-US': updateData.excerpt },
        content: { 'en-US': updateData.content },
        tags: { 'en-US': updateData.tags || [] },
        publishDate: { 'en-US': updateData.publishDate },
      },
